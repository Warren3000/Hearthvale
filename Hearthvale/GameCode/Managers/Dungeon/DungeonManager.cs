...
public class DungeonManager
{
    ...
    protected virtual DungeonSwitch CreateDungeonSwitch(XElement element)
    {
        var id = element.Attribute("id").Value;
        var col = int.Parse(element.Attribute("col").Value);
        var row = int.Parse(element.Attribute("row").Value);
        var inactiveTileId = int.Parse(element.Attribute("inactiveTileId").Value);
        var activeTileId = int.Parse(element.Attribute("activeTileId").Value);
        ...
        return new DungeonSwitch(id, col, row, inactiveTileId, activeTileId, switchType, duration);
    }
    ...
    protected virtual DungeonLever CreateDungeonLever(XElement element)
    {
        var id = element.Attribute("id").Value;
        var col = int.Parse(element.Attribute("col").Value);
        var row = int.Parse(element.Attribute("row").Value);
        ...
        return new DungeonLever(id, col, row, inactiveTileId, activeTileId, leverType);
    }

    protected virtual DungeonPressurePlate CreateDungeonPressurePlate(XElement element)
    {
        var id = element.Attribute("id").Value;
        var col = int.Parse(element.Attribute("col").Value);
        var row = int.Parse(element.Attribute("row").Value);
        ...
        return new DungeonPressurePlate(id, col, row, inactiveTileId, activeTileId, plateType, weightRequired);
    }
