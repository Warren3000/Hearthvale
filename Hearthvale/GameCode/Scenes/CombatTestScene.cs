...
{
    public class CombatTestScene : Scene, ICameraProvider
    {
        ...
        public override void LoadContent()
        {
            ...
            _waveManager = new WaveManager(_npcManager, _player);
            _waveManager.LoadConfig("Content/data/waves.json");
...
private void DebugDrawWeaponProbe()
{
    ...
    else
    {
        ...
        private void HandleStartClicked(object sender, EventArgs e)
        {
            ...
            Core.ChangeScene(GameSceneFactory.CreateCombatTestScene());
        }
